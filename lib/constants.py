...
# High score to indicate that an archive could not be processed safely.
HIGH_SEVERITY_ARCHIVE_ERROR = 1337


OPCODES_4BYTE_LEN = (b"B",)
OPCODES_8BYTE_LEN = (b"\x8e", b"\x96")
OPCODES_1BYTE_LEN = (b"C",)
LENGTH_PREFIXED_OPCODES = OPCODES_4BYTE_LEN + OPCODES_8BYTE_LEN + OPCODES_1BYTE_LEN
